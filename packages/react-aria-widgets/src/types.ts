...
> {
  ...
  defaultProps?: Partial<PolymorphicComponentPropsWithRef<React.ElementType, P>> | undefined;
  propTypes?: React.WeakValidationMap<PolymorphicComponentPropsWithRef<React.ElementType, P>> | undefined;
